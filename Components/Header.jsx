  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28 header'>
      <div className='flex justify-between items-center '>
        ...
        <Link href="/admin" className="flex items-center gap-2 bg-black text-white px-5 py-3 rounded-lg hover:bg-gray-800 transition w-fit">
          🔒 Admin Panel
        </Link>
      </div>
      <div className='text-center my-8'>
          <h1 className='text-3xl sm:text-5xl font-medium'>ISTIQBOL YO‘LI</h1>
          <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-3xl'>Yuksaklikka eltuvchi yo‘l</p>
